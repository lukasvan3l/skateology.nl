...
function filesize(urlFunction)
	...
	set f=fs.GetFile("C:\domains\skateology.nl\wwwroot\bestanden\" & urlFunction)
...
Function deleteFile(file)
	...
	dim fs
	Set fs = Server.CreateObject("Scripting.FileSystemObject")
	if fs.FileExists( "C:\domains\skateology.nl\wwwroot\" & file ) then
		fs.DeleteFile( "C:\domains\skateology.nl\wwwroot\" & file )
	else
